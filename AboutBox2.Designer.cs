namespace abracadabra
{
    partial class AboutBox2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxDescription.Text = "Приложение для оптового склада продовольственных товаров. Позволяет просматривать" +
    ", добавлять, редактировать и удалять данные в/из базы данных в соответствии с ро" +
    "лью пользователя.";
            // 
            // okButton
            // 
